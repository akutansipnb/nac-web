                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="input-tm-link" id="input-date-tm" name="tm_url" class="form-control" placeholder="20/01/2001">
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <div class="form-check" id="input-tm-method">
                        <input class="form-check-input" type="radio" name="tm_method" id="flexRadioDefault1">
                        <label class="form-check-label" for="flexRadioDefault1">
                          Youtube
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="tm_method" id="flexRadioDefault2" checked>
