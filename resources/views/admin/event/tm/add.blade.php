                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="date" id="input-date-tm" name="tm_date" class="form-control" placeholder="20/01/2001">
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label class="form-control-label" for="input-tm-link">Link Technical Meeting </label>
                      <input type="input-tm-link" id="input-date-tm" name="tm_url" class="form-control" placeholder="https://meet.com">
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <div class="form-check" id="input-tm-method">
                        <input class="form-check-input" type="radio" name="tm_method" value="youtube" id="flexRadioDefault1">
                        <label class="form-check-label" for="flexRadioDefault1">
                          Youtube
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" value="zoom" type="radio" name="tm_method" id="flexRadioDefault2" checked>
