      ...
      <div class="header-body">
        <div class="row align-items-center py-4">
          <div class="col-lg-12 col-12 text-right">
            <a href="{{route('school.create')}}" class="btn btn-sm btn-neutral">Tambah Sekolah</a>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="table-responsive">
            <table class="table align-items-center table-flush">
              <thead class="thead-light">
                <tr>
                  <th scope="col" class="sort" data-sort="name">Nama Sekolah</th>
                  <th scope="col" class="sort" data-sort="date">Telepon Sekolah</th>
                      ...
                      <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                        ...
                        <a class="dropdown-item" href="{{ route('school.edit',$item->id) }}">Edit Sekolah</a>
                          <form action="{{route('school.destroy', ['school' => $item->id])}}" method="post">
                            @csrf
                            @method('DELETE')
                            <button class="dropdown-item">Hapus Sekolah</button>
                          </form>
                      </div>
                    </div>
                  </td>
