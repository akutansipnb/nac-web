...
<body>
    ...
    <div id="mySidenav" class="delay-300 duration-300 ease-in-out bg-white w-0 h-full z-50 fixed overflow-x-hidden top-0 left-0 flex flex-col items-center pt-36">
        ...
        <div class="flex flex-col items-center space-y-4 text-gray-700">
            ...
            <a class="hover:text-black duration-500 ease-in-out text-lg font-semibold" href="#">Galeri</a>
    ...
    <footer class="text-white bg-gray-900 lg:grid lg:grid-cols-5">
        <aside class="hidden lg:relative lg:col-span-2 lg:block">
            <img src="https://images.unsplash.com/photo-1624456735729-03594a40c5fb?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=668&q=80"
                alt="Comic graphic" class="absolute inset-0 object-cover w-full h-full" />
        </aside>
        ...
        <div class="px-4 py-16 sm:px-6 lg:px-8 lg:col-span-3">
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
                <div>
                    ...
                    <div class="flex mt-16 space-x-3">
                        ...
                        <a href="" target="_blank" rel="noreferrer" aria-label="Dribble"
                            class="p-2 border border-white border-opacity-25 rounded-full hover:opacity-75">
                            <svg fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" class="w-4 h-4">
                                <path fill-rule="evenodd"
            ...
            <div class="pt-12 mt-12 border-t border-gray-800">
                ...
                <p class="mt-8 text-xs text-gray-500">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus mollitia quia quod repellendus.
                    Porro harum,
                    odio dolore perspiciatis praesentium provident esse consequatur quibusdam aperiam, cupiditate omnis
                    modi in
                    quasi? In, maxime odio vel repellat sed earum? Debitis quaerat facilis animi. Odio natus nostrum
                    laboriosam
