...
<div class="max-w-screen-xl px-2 py-5 mx-auto sm:px-6 lg:px-8 my-10">
    <div class="max-w-lg mx-auto">
      <h1 class="text-2xl font-bold text-center gradient-text sm:text-3xl">Register Your School!</h1>

      <p class="max-w-md mx-auto mt-4 text-center text-gray-500">
        Your school isn't registered yet? Register Now
      </p>
        ...
        <div class="bg-input flex justify-center">
            <div class="input flex flex-col w-10/12 xl:w-11/12">
                <form action="{{route('academies.store')}}" method="POST">
                    ...
                    <label for="text" class="font-medium font-semibold">School/Institution Name</label>
                    <div class="relative">
                      ...
                      @csrf
                        <input
                          ...
                          id="name"
                          name="academy_name"
                          placeholder="Input School/Institution Name"
                          class="w-full mt-2 mb-5 p-4 pr-4 border-2 border-gray-200 rounded-lg sm:text-sm"
                          required
                        />
                    </div>

                    <label for="number" class="font-medium font-semibold mt-5">School/Institution Phone Number</label>
                    <div class="relative">
                          ...
                          <input
                            ...
                            id="handphone"
                            name="phone"
                            placeholder="Input School/Institution Phone Number"
                            class="w-full mt-2 mb-5 p-4 pr-4 border-2 border-gray-200 rounded-lg sm:text-sm"
                            required
                          />
                    </div>

                    <label for="textarea" class="font-medium font-semibold ">School/Institution Address</label>
                    <div class="relative">
                      ...
                      <textarea
                        ...
                        id="addres"
                        name="address"
                        placeholder="Input School/Institution Address"
                        class="w-full mt-2 mb-5 p-4 pr-4 border-2 border-gray-200 rounded-lg sm:text-sm"
                        required
                      ></textarea>
                    </div>
