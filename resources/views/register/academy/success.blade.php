...
<div class="max-w-screen-2xl px-2 py-5 mx-auto sm:px-6  lg:px-8 my-10">
    <div class="max-w-lg mx-auto">
      <h1 class="text-2xl font-bold text-center gradient-text sm:text-3xl">Data Successfully Added</h1>

      <p class="max-w-md mx-auto mt-5 text-center text-gray-500">
        Institution {{ $academy_name }} Successfully added, Continue to select the competition branches to be entered.
      </p>
